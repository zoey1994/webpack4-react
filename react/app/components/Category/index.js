	...
	render(){
		...
		return(
			<div className="home-category">
				<ReactSwipe className="carousel" swipeOptions={opt}>
                    ...
                    <div className="carousel-item">
                        <ul className="clear-fix">
                            ...
                            <Link to="/search/xuixianyule"><li className="float-left xiuxianyule">休闲娱乐</li></Link>
	            ...
	            <div className="home-category-index clear-fix">
	            	<span className={this.state.index===0?"selected float-left":"float-left"}></span>
	            	<span className={this.state.index===1?"selected float-left":"float-left"}></span>
	            	<span className={this.state.index===2?"selected float-left":"float-left"}></span>
	            </div>
	         </div>
		)
	}
